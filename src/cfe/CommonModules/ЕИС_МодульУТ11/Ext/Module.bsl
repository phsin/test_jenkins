...
Функция НайтиЕдиницуИзмерения(КодЕдиницы) Экспорт
	...
	ЕдиницаИзмерения = Справочники.УпаковкиЕдиницыИзмерения.НайтиПоКоду(КодЕдиницы);
...
Функция КодИНаименованиеЕдиницыИзмеренияКВыгрузке(СтрокаТЧ) Экспорт
	...
	Возврат Новый Структура("Код, Наименование", ЕдиницаИзмерения.Код, ЕдиницаИзмерения.НаименованиеПолное);
...
Функция НайтиПодчиненныйСчетФактура(ДокОснование) Экспорт
	...
	ТаблицаСчетаФактуры = Документы.СчетФактураВыданный.СчетаФактурыПоОснованию(ДокОснование, Неопределено,  Неопределено, Ложь);
...
Функция ПолучитьСведенияОбОрганизации(Организация) Экспорт
	...
	Возврат ФормированиеПечатныхФорм.СведенияОЮрФизЛице(Организация, ТекущаяДатаСеанса());
