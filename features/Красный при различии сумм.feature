...
Сценарий: работа с документом Реализация товаров и услуг Б000000156 от 18.03.2025 11:36:26
	*Открытие раздела
	...
	*Проверка цвета (белый)
		...
		И в таблице 'Отгрузки' я устанавливаю флаг с именем 'ОтгрузкиОтметка'
		И я нажимаю на кнопку с именем 'СоздатьДокументыОтгрузки'
		И в таблице "Отгрузки" у поля "Цвет" я жду значения "Бел" в течение 20 секунд
