...
# И Я подключаю клиент тестирования "SSR" из таблицы клиентов тестирования
	...
	И я запоминаю строку "D:\1cBase\Tests\Работа с xml\Шаблоны  для сравнения файлов\Шаблон по ССР\Новые шаблоны\ON_NSCHFDOPPR_2ZK-CUS-08735000018_2ZK-SUP-00019144920_20250823_bb43ab7c-0b04-45a1-9941-7048d80773fb_0_0_0_0_0_00.xml" в переменную "ШаблонОсновы"
	И я запоминаю строку "D:\1cBase\Tests\Работа с xml\Шаблоны  для сравнения файлов\Шаблон по ССР\Новые шаблоны\PRIL_ON_NSCHFDOPPR_2ZK-CUS-08735000018_2ZK-SUP-00019144920_20250823_bb43ab7c-0b04-45a1-9941-7048d80773fb_0_0_0_0_0_00.xml" в переменную "ШаблонПриложений"

Сценарий: 01 Сравнение двух файлов
	*Открытие раздела
...
*Отправка контейнера и сравнение файлов
		...
		И Я запоминаю значение выражения 'Сред($СобщениеПутей$, СтрНайти($СобщениеПутей$, "C:\1cBase\Разработка\logs\ON_NSCHFDOPPR_") , 143)' в переменную "ПутькФайлуОсновному"
		И Я запоминаю значение выражения 'Сред($СобщениеПутей$, СтрНайти($СобщениеПутей$, "C:\1cBase\Разработка\logs\PRIL_ON_NSCHFDOPPR_"), 148)' в переменную "ПутькФайлуПриложения"
